...
<html lang="en">
    ...
    <head>
        ...
        <!-- PAGE TITLE -->
        <title>portofolio - zulham</title>
       
        <!-- FAVICON -->
        <link rel="shortcut icon" href="<?=$url?>/img/favicon.png">  <!-- tambahkan php echo dengan <?=$url?> -->
                ...
                <section id="service">
                    ...
                    <ul class="services-list">
                       ...
                       <!--  <li class="scroll-animated-from-right"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Desain Grafis</li>
                        ...
                        <li class="scroll-animated-from-right"><i class="fa fa-pencil-square-o" aria-hidden="true"></i><?= $key->nama_skill;?></li>
                        <?php endforeach; ?>
