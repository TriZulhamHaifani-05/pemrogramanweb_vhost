        ...
        <div class="content-area">
            ...
            <div class="content-area-inner">
                ...
                <section id="intro">
                    ...
                    <div class="container-mid">
                        ...
                        <div class="animation-container animation-fade-left" data-animation-delay="300">
                            ...
                            <p class="subline">Saya merupakan mahasiswa Politeknik Kampar dengan Program Studi Teknik Informatika. Saat ini duduk di bangku tingkat 2 yaitu Lebih tepatnya semester 4</p>
                        ...
                        <div class="animation-container animation-fade-up" data-animation-delay="600">
                            ...
                            <a href="#about" class="smooth-scroll">Lebih Banyak<i class="fa fa-angle-down" aria-hidden="true"></i></a>
                ...
                <section id="about">
                    ...
                    <h3 class="headline scroll-animated-from-right">Apa yang dapat Saya Bantu?</h3>
                    
                    <p class="scroll-animated-from-right">Jik anda mempunya masalah dalam membuat program.</p>

                    <p class="scroll-animated-from-right">Masalah akan terselesaikan dengan anda menghubungi saya, karena tugas saya adalah membantu anda</p>
                ...
                <section id="service">
                    ...
                    <h3 class="headline scroll-animated-from-right">Bidang Keahlian</h3>
                    ...
                    <ul class="services-list">
                        ...
                        <li class="scroll-animated-from-right"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Desain Grafis</li>
                        <li class="scroll-animated-from-right"><i class="fa fa-eye" aria-hidden="true"></i>Web Desain</li>
                        <li class="scroll-animated-from-right"><i class="fa fa-database" aria-hidden="true"></i>Teknisi</li>
                        <li class="scroll-animated-from-right"><i class="fa fa-television" aria-hidden="true"></i>Photografer</li>
                ...
                <section id="work">
                    ...
                    <h3 class="headline scroll-animated-from-right">Hasil Kerja</h3>
                ...
                <section id="contact">
                    ...
                    <ul class="contact-list">
                        ...
                        <li class="scroll-animated-from-right"><i class="fa fa-mobile" aria-hidden="true"></i>0822 3542 5278</li>
                        <li class="scroll-animated-from-right"><i class="fa fa-envelope-o" aria-hidden="true"></i>trizulham2018@mail.com</li>
